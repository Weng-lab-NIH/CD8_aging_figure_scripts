...
pbmc <- readRDS("./batchCorrected_matrix_clusterFltr_logNorm_log2.Rds") 
...
warnings()
file_out <- "./21.5.0_Dataframe_DifferentialExpression_BatchCorrected_CD8_Ttest_logNorm.csv"
...
df <- read_csv('./clustering_metadata_logNorm.csv', guess_max = 100000)
pheno <- read_csv('./pheno_assgnmnt_logNorm.csv', guess_max = 100000)
expression_mat <- readRDS('./batchCorrected_matrix_clusterFltr_logNorm_log2.Rds')
# genes <- scan('./data/external/210313_HeatmapGenes_Fig1', what='')
...
write.table(heat_mat_2, paste('./',version,'_Matrix_ChosenDiffExp.Ordered_scaled_integrated_logNorm_031321.txt',sep=''))
write.csv(heat_mat_2, paste('./',version,'_Matrix_ChosenDiffExp.Ordered_integrated_logNorm_031321.csv',sep=''))
